...
let array_map = Implang.StringMap.empty
...
let verification_condition = Z3.Boolean.mk_not ctx (exprToZ3Predicate ctx (Verifier.stmtToPredicate array_map result post_condition));;
